...
const Experience = () => {
  ...
  //   "Experienced software developer with a strong background in React and Node.js.",
  //   "Specialized in crafting innovative web applications, including AR projects.",
  //   `With [X] years of hands-on expertise, I bring a keen eye for detail and a passion for solving complex challenges.`,
  //   // "Eager to contribute to cutting-edge projects and push the boundaries of innovation.",
    ...
    <div>
      <div className="exp-wrapper" ref={wraper}>
        ...
        <div className="exp-container scrollx" ref={container}>
          ...
          {developerOverview.map((text, index) => (
         ...
         <img src={arrowdown} className="arrowdown" id='scrolldown'></img>
          ...
          <section className="sec3 pin">
            ...
            <div className="col anim">
              <p className='exp-text currr'>
                Created reusable React components that played a pivotal role in significant commercial projects, seamlessly integrated and utilized across the entire application.        </p>
